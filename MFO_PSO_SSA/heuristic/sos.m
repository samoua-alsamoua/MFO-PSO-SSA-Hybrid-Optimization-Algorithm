function [bestSolution, bestFitness, iteration] = sos(p, dimension, maxIteration)
...
while FE<maxFE 
    ...
    for i=1:ecosize % Organisms' Looping
        ...
        % Mutualism Phase
            ...
            fitnessNew1 = testFunction(ecoNew1', p);
            fitnessNew2 = testFunction(ecoNew2', p);
        ...
        % Parasitism Phase
            ...
            fitnessParasite = testFunction(parasiteVector', p);
