clear
clc
% algorithms = {'WChOA','FDB_WChimp_CASE15','FDB_WChimp_CASE28','FDB_WChimp_CASE30','FDB_WChimp_CASE40','FDB_WChimp_CASE41', 'FDB_WChimp_CASE13','FDB_WChimp_CASE49','FDB_WChimp_CASE57', 'DAOA', 'DDAO', 'LFD', 'HHO', 'NCHHO', 'SAO'};
algorithms = {'pso','abc','cs','de','sos','ssa', 'sca','mfo','hho','gwo','woa'};
algorithmsNumber = length(algorithms); functionsNumber = 100; experimentNumber = 3; run = 25;  
...
for i = 1 : algorithmsNumber
    filename = strcat(source, algorithms{i},'-d=',int2str(dimension),'.xlsx');
...
filename = strcat(source, '-result-d=',int2str(dimension),'.xlsx');
